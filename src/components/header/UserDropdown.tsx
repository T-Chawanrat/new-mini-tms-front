...
export default function UserDropdown({ variant = "name" }: UserDropdownProps) {
  ...
  return (
    <div className="relative">
      <button
        ...
        className={
          variant === "dots"
            ? "flex items-center justify-center w-9 h-9 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800"
      ...
      {showChangePasswordModal && (
        <div
          className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/40 backdrop-blur-sm px-4 py-6"
        ...
        >
          ...
          >
            <button
              type="button"
              onClick={() => setShowChangePasswordModal(false)}
              className="absolute right-4 top-4 z-10 rounded-lg px-2 py-1 text-slate-400 hover:bg-gray-100 hover:text-slate-600"
            >
              ✕
            </button>
